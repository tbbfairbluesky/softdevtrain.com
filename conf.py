...
BLOG_AUTHOR = "Software Development Training LLC"  # (translatable)
BLOG_TITLE = "Software Development Training LLC"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.SoftDevTrain.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.SoftDevTrain.com/"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/pages/helpful-links.html", "Helpful Links"),
